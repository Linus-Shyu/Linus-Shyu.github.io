window.PORTFOLIO_I18N = {
  zh: {
    about: {
      title: "个人简介",
      para1: "我叫林纳斯，来自青海，目前是一名高二学生。热爱计算机科学，享受动手开发有趣的项目，同时也是一名科技领域的自媒体创作者，乐于分享所学所得。大家可以在B站或YouTube上找到我的频道「Linus Shyu」，那里记录了我的学习与创作点滴。",
    ...
    hobby: {
      title: "我的爱好",
      para1: "我是一名科技领域的自媒体创作者，我非常喜欢分享我在科技中所学到的东西，这是我的 Bilibili 频道和 YouTube 频道。",
    ...
    comp: {
      ...
      music: "音乐领域",
      volunteer: "志愿者经历",
      tsinghua: "清华大学程序设计竞赛 2026 初赛：入围者",
      google: "Google 2025 开发者大会：嘉宾",
      adventurex: "Adventure X 2025 黑客松：赛道获奖（XTerminal）",
      noi25: "NOI 2025 冬令营：入围者",
      noi24: "NOI 2024 冬令营：入围者",
      noip24: "2024 全国青少年信息学奥林匹克联赛：入围者",
      noip23: "2023 全国青少年信息学奥林匹克联赛：入围者",
      qinghai40: "青海省第四十届青少年科技创新大赛：入围者",
      stanford: "斯坦福数学锦标赛 2024 线上：入围者",
      robotCaptain: "某学校的机器人队队长",
      qinghai15: "青海省第十五届中小学生机器人竞赛：入围者",
      huzhu: "互助区中小学机器人科技节：入围者",
      piano7: "2020 中国音乐学院钢琴考级七级",
      theoryMid: "2019 中央音乐学院乐理考级中级",
      piano4: "2020 中国音乐学院钢琴考级四级",
      theoryBegin: "2018 中央音乐学院乐理考级初级",
      piano2: "2019 中央音乐学院钢琴考级二级",
      cop28: "第二十八届联合国气候变化大会：志愿者"
    },
    hero: {
      eyebrow: "17岁开发者 · 创业公司 CTO · 极简主义推崇者",
    ...
    projects: {
      ...
      photo: {
        title: "风光摄影.",
        subhead: "星空与自然。",
        body: "风光摄影师。用镜头记录青海与旅途中的星空、银河与自然景观。",
        link: "Instagram 查看 >"
      },
      homelab: {
        title: "Homelab.",
        subhead: "家庭实验室玩家。",
        body: "Homelab 玩家，在 B 站分享硬核的计算机科学与科技知识。Dell PowerEdge、VMware ESXi 等企业级虚拟化与服务器实践。",
        link: "B 站频道 >"
      },
      paytube: {
        title: "PayTube.",
        subhead: "极客专属的加密支付引擎。",
        body: "区块链与 Web3 开发者，也是矿工。PayTube 支持以太坊等多链，前端直连 MetaMask，用加密货币支持开源与创作者。",
        link: "打开 PayTube >"
      },
    ...
    skills: {
      title: "技能与经历",
      techStack: "技术栈与数字美学",
      rustLabel: "Rust（高性能开发）",
      pythonLabel: "Python（XTerminal、脚本与自动化）",
      swiftLabel: "Swift（移动端生态）",
      cppLabel: "C++（算法竞赛）",
      neovimLabel: "Neovim（深度配置办公）",
      ...
      volunteer: "跨界经历",
      volunteerText: "COP28 联合国气候变化大会志愿者。",
      art: "艺术",
      artText: "钢琴七级；风光摄影师。",
      journey: "教育目标",
      journeyText: "2027 高考目标香港大学 (HKU)，最终前往 MIT 深造。"
    },
    ui: {
      themeLight: "浅色",
      themeDark: "深色",
  ...
  en: {
    about: {
      title: "About me",
      para1: "I'm Linus, from Qinghai. I'm currently a Grade 11 student. I love computer science and enjoy building interesting projects. I'm also a tech creator and like to share what I learn. You can find my channel \"Linus Shyu\" on Bilibili or YouTube, where I document my learning and creations.",
    ...
    hobby: {
      title: "My hobby",
      para1: "I am a self-media creator in the technology field. I really like to share what I have learned in technology. This is my Bilibili channel and YouTube channel.",
    ...
    comp: {
      ...
      tsinghua: "Tsinghua University Programming Contest Preliminary Contest 2026: Finalists",
      google: "Google I/O Connect China: Guest",
      adventurex: "Adventure X 2025 Hackathon: Track Winner (XTerminal)",
      noi25: "NOI 2025 Winter Camp: Finalists",
      noi24: "NOI 2024 Winter Camp: Finalists",
      noip24: "2024 National Olympiad in Informatics in Provinces: Finalists",
      noip23: "2023 National Olympiad in Informatics in Provinces: Finalists",
      qinghai40: "The 40th Qinghai Youth Science and Technology Innovation Competition: Finalists",
      stanford: "Stanford Math Tournament 2024 Online: Finalists",
      robotCaptain: "Captain of a school's robotics team",
      qinghai15: "The 15th Qinghai Province Primary and Secondary School Student Robot Competition: Finalists",
      huzhu: "Huzhu District Primary and Secondary School Robot Science Festival: Finalists",
      piano7: "2020 China Conservatory of Music Piano Test Level 7",
      theoryMid: "2019 Central Conservatory of Music Music Theory Examination Intermediate Level",
      piano4: "2020 China Conservatory of Music Piano Test Level 4",
      theoryBegin: "2018 Central Conservatory of Music Music Theory Examination Beginner",
      piano2: "2019 Central Conservatory of Music Piano Grade Level 2",
      cop28: "The 28th United Nations Climate Change Conference: Volunteer"
    },
    hero: {
    ...
    projects: {
      ...
      photo: {
        ...
        subhead: "Stars & nature.",
        body: "Landscape photographer. Capturing the night sky, Milky Way, and natural scenery in Qinghai and on the road.",
        link: "View on Instagram >"
      },
      homelab: {
        title: "Homelab.",
        subhead: "Home lab enthusiast.",
        body: "Homelab player. Sharing hardcore computer science and tech knowledge on Bilibili. Dell PowerEdge, VMware ESXi, and enterprise virtualization at home.",
        link: "Bilibili Channel >"
      },
      paytube: {
        title: "PayTube.",
        subhead: "Crypto payment engine for geeks.",
        body: "Blockchain & Web3 developer and miner. PayTube supports Ethereum and more; connect MetaMask and support open source with crypto.",
        link: "Open PayTube >"
      },
    ...
    skills: {
      ...
      techStack: "Tech Stack & Aesthetics",
      rustLabel: "Rust (high-performance)",
      pythonLabel: "Python (XTerminal, scripting & automation)",
      swiftLabel: "Swift (mobile ecosystem)",
      cppLabel: "C++ (competitive programming)",
      neovimLabel: "Neovim (daily driver)",
      ...
      volunteerText: "COP28 UN Climate Change Conference volunteer.",
      art: "Art",
      artText: "Piano Grade 7; landscape photographer.",
      journey: "Journey",
      journeyText: "HKU 2027 → MIT."
    },
    ui: {
      themeLight: "Light",
      themeDark: "Dark",
