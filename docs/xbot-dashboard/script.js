...
const translations = {
  en: {
    ...
    rail_boundary_title: "Zero-read route loop",
    rail_boundary_reads: "0 X reads",
    rail_boundary_ack: "Human ACK",
    rail_boundary_budget: "Cost partition sealed",
    ...
    x_api_budget: "X API Cost Partition",
    ...
    outcome_api_left: "X API partition headroom",
    ...
    pipeline_metric_budget: "Cost partition",
    ...
    arbiter_budget_gate: "cost partition",
    ...
    runlog_budget_left: "{amount} cost boundary left",
    ...
    governor_title: "X API cost-partition reactor",
    ...
    budget_alloc_title: "Cost-to-L7 router",
  ...
  zh: {
    ...
    rail_boundary_title: "零读取路由闭环",
    rail_boundary_reads: "0 次 X 读取",
    rail_boundary_ack: "人工确认",
    rail_boundary_budget: "成本分区封闭",
    nav_overview: "总览",
    nav_services: "服务",
    nav_workflow: "流程",
    nav_queue: "群体队列",
    ...
    runlog_budget_left: "成本边界剩余 {amount}",
